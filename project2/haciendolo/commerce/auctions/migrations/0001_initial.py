    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('User', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='User_Listing', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='WatchList',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Listing', models.ManyToManyField(blank=True, related_name='Listing_WatchList', to='auctions.Listing')),
                ('User', models.ForeignKey(blank=True, default=None, on_delete=django.db.models.deletion.CASCADE, related_name='User_WatchList', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
